    ...
    <div class="carousel-inner">
      <div class="carousel-item active c-item">
        ...
        <div class="carousel-caption top-0 mt-4">
          <p class="mt-2 fs-3 text-uppercase">Downfall Music Hardcore and Metal Website</p>
        </div>
      </div>
      <div class="carousel-item c-item">
        ...
        <div class="carousel-caption top-0 mt-4">
          <p class="text-uppercase fs-3 mt-2">Downfall Music Hardcore and Metal Website</p>
        </div>
      </div>
      <div class="carousel-item c-item">
